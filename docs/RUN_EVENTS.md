...
| NEXT_MOVE_SELECTED | evidence revision id/hash, deep evaluation ref, `deep-policy-v2`, move (`COMPLETE`/`FOLLOW_UP`/`ABSTAIN`), reason_code, dimensions, thresholds, `executed: false` |
