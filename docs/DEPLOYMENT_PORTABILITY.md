...
Required: Python 3.12+, Node.js satisfying the chosen stable Next.js engine requirement, npm, and local disk. The implemented Phase 1–3 runtime uses pinned dependency ranges in `pyproject.toml`; the verified local environment is Python 3.14.3 / Node 24.13.1 while CI pins Python 3.12 / Node 22.
