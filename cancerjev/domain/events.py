...
REGISTERED_EVENT_TYPES = frozenset({
    ...
    "PROGRAM_RUN_STARTED", "CAMPAIGN_SELECTED", "CAMPAIGN_COMPLETED", "CAMPAIGN_BLOCKED",
    "CAMPAIGN_DISPATCH_FAILED", "RELEASE_OBSERVED",
    "PROGRAM_IDLE",
    "WIDE_SCAN_STARTED", "WIDE_SCAN_COMPLETED",
    "PRE_WIDE_SELECTION_RECORDED",
    ...
    "HYPOTHESES_GENERATED", "HYPOTHESIS_EVALUATED", "HYPOTHESIS_POLICY_RECORDED",
