...
def read_hypothesis_draft(value: object, *, allowed_action_ids: frozenset[str]) -> HypothesisDraft:
    ...
    return HypothesisDraft(_text(record["statement"]), _text(record["proposed_mechanism"]),
