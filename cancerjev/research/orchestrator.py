...
class DemoOrchestrator:
    ...
    def _make_dossier(self, run_id, candidate, baseline, after, fixture_hypotheses, make_id):
        ...
        summary = {"dossier_id": dossier_id, "run_id": run_id, "candidate_id": candidate["candidate_id"], "mode": "FAKE", "entity": candidate["entity"], "warning": WARNING, "json_artifact_id": json_artifact.artifact_id, "markdown_artifact_id": md_artifact.artifact_id}
