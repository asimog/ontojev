...
def test_production_allowances_are_centralized_and_adaptive():
    from cancerjev.gdc.budget import production_caps
    caps = production_caps(per_response_bytes=5 * 1024 * 1024, timeout_seconds=30)
    assert caps.adaptive
    assert caps.max_bytes == 768 * 1024 * 1024
    assert caps.max_shard_bytes == 512 * 1024 * 1024
